...
class ConfigLoaderTest {
    ...
    void shouldImportConfig() throws IOException {
        ...
        assertThat(config.getReporting().get("console")).extracting("enabled").containsExactly(false);
        assertThat(config.getReporting().get("markdown")).extracting("enabled").containsExactly(true);
    }
