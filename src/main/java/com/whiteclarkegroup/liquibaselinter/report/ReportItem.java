...
public final class ReportItem {
    ...
    public static ReportItem skipped(DatabaseChangeLog databaseChangeLog, ChangeSet changeSet, String rule, String message) {
        return create(databaseChangeLog, changeSet, rule, message, ReportItemType.SKIPPED);
    }
