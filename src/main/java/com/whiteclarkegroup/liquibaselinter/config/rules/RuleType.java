...
public enum RuleType {
    ...
    PRIMARY_KEY_NAME("primary-key-name", PatternRule::new, "Primary key name is missing or does not follow pattern"),
    FOREIGN_KEY_NAME("foreign-key-name", PatternRule::new, "Foreign key name is missing or does not follow pattern"),
